...
if(plate_type == 'rectangle')
    centered_xy_coordinates = return_centered_rectangular_plate_coordinates(center_xi, center_yi, Dx, Dy, plate_lx, plate_ly);
    rectangular_corner_1=centered_xy_coordinates(1,:);   
    rectangular_corner_2=centered_xy_coordinates(size(rectangular_corner_1,2),:);  
else 
